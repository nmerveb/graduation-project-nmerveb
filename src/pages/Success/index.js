  ...
  return (
    <>
      ...
      <div className={styles.SuccessFormContainer}>
        <div className={styles.SuccessFormTitle}>
            İşlem Başarılı
        </div>
        <div className={styles.SuccessFormContent}>
          ...
          <div className={styles.QueryCodeInfo}>
            ...
            <div className={styles.QueryCodeDescription}>Başvurunuz alınmıştır.<br/><br/>
            Aşağıda belitirlen kod ile başvurunuzun durumunu kontrol edebilirsiniz</div>
